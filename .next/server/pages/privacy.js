...
function Privacy({}) {
    ...
    const { data , error  } = (0,react_query__WEBPACK_IMPORTED_MODULE_4__.useQuery)([
        "privacy",
        locale
    ], ()=>services_faq__WEBPACK_IMPORTED_MODULE_5__/* ["default"].getPrivacy */ .Z.getPrivacy());
    if (error) {
...
var __webpack_exports__ = __webpack_require__.X(0, [5728,4169,8886], () => (__webpack_exec__(39405)));
