...
/* harmony export */   "default": () => (/* binding */ Promotion)
/* harmony export */ });
...
function Promotion({}) {
    ...
    const { data , error , fetchNextPage , hasNextPage , isFetchingNextPage , isLoading  } = (0,react_query__WEBPACK_IMPORTED_MODULE_4__.useInfiniteQuery)([
        "bannerPaginate",
        locale
    ], ({ pageParam =1  })=>services_banner__WEBPACK_IMPORTED_MODULE_5__/* ["default"].getAll */ .Z.getAll({
            page: pageParam,
            perPage: 10
        }), {
...
var __webpack_exports__ = __webpack_require__.X(0, [2078,676,1664,5728,4169,1717], () => (__webpack_exec__(42537)));
