...
/* harmony export */   "default": () => (/* binding */ ReferralTerms),
...
/* harmony import */ var services_information__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(49073);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([services_information__WEBPACK_IMPORTED_MODULE_5__, utils_session__WEBPACK_IMPORTED_MODULE_7__]);
([services_information__WEBPACK_IMPORTED_MODULE_5__, utils_session__WEBPACK_IMPORTED_MODULE_7__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
function ReferralTerms({}) {
    ...
    const { data , error  } = (0,react_query__WEBPACK_IMPORTED_MODULE_4__.useQuery)([
        "referral-terms",
        locale
    ], ()=>services_information__WEBPACK_IMPORTED_MODULE_5__/* ["default"].getReferrals */ .Z.getReferrals());
    if (error) {
...
var __webpack_exports__ = __webpack_require__.X(0, [5728,4169,8886], () => (__webpack_exec__(24219)));
