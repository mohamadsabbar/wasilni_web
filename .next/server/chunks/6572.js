...
/* harmony export */   "Z": () => (/* binding */ ParcelReview)
/* harmony export */ });
...
/* harmony import */ var services_parcel__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(47763);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([components_alert_toast__WEBPACK_IMPORTED_MODULE_10__, services_parcel__WEBPACK_IMPORTED_MODULE_11__]);
([components_alert_toast__WEBPACK_IMPORTED_MODULE_10__, services_parcel__WEBPACK_IMPORTED_MODULE_11__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
function ParcelReview({ handleClose , refetch  }) {
    ...
    const { isLoading , mutate  } = (0,react_query__WEBPACK_IMPORTED_MODULE_9__.useMutation)({
        mutationFn: (data)=>services_parcel__WEBPACK_IMPORTED_MODULE_11__/* ["default"].review */ .Z.review(orderId, data),
        onSuccess: ()=>{
            refetch();
            handleClose();
            (0,components_alert_toast__WEBPACK_IMPORTED_MODULE_10__/* .success */ .Vp)(t("thanks.for.feedback"));
        },
        onError: ()=>{
            (0,components_alert_toast__WEBPACK_IMPORTED_MODULE_10__/* .error */ .vU)(t("request.not.sent"));
        }
    });
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ParcelReviewContainer)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(20997);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(16689);
...
/* harmony import */ var components_orderReview_parcelReview__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(33081);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([components_orderReview_parcelReview__WEBPACK_IMPORTED_MODULE_5__]);
components_orderReview_parcelReview__WEBPACK_IMPORTED_MODULE_5__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
function ParcelReviewContainer({ open , onClose , refetch  }) {
    ...
    if (isDesktop) {
        return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(containers_modal_modal__WEBPACK_IMPORTED_MODULE_3__["default"], {
            open: open,
            onClose: onClose,
            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(components_orderReview_parcelReview__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, {
                handleClose: onClose,
                refetch: refetch
            })
        });
